...
//				alert(is.getElementsByTagName("li").length*window.screen.width);
...
var bs=document.getElementsByClassName("barSelected")[0];
bs.getElementsByTagName("img")[0].setAttribute("src",bs.getElementsByTagName("img")[0].getAttribute("data-src"));